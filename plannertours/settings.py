...
SECRET_KEY = 'dy%dy9#o^u7p)om0%gh4n&w^#0rcq)4aa2-c2^!3gbywd=ixlg'
...
ALLOWED_HOSTS = [
    u'*.planner.tours',
    u'demo.planner.tours',
    u'mctours.planner.tours',
    u'www.planner.tours',
    u'107.180.103.216',
    u'demo.mistenants.com',
    u'mistenants.com',
#    u'shorexplan.com',
#    u'demo.shorexplan.com',
    u'192.168.0.21',
]
...
CORS_ORIGIN_WHITELIST = [
    'http://localhost',
    'http://shorexplan.com',
#    'http://demo.shorexplan.com',
    'http://lathonduras.com',
...
WSGI_APPLICATION = 'plannertours.wsgi.application'
